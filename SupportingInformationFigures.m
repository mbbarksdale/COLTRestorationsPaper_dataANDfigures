%% Fig S1: Sea level over time
figure
for RSLRA=[0.1592,0.1106,0.08023,0.03536,0.01881]
    load(['Outputs_CO10_RSLRA' num2str(RSLRA) '_spinuprampedRSLR1_runstartRSLR3_Breakwater0_SSCReduction0_breakwaterdelay551_TLP0_TLPthick0_TLPfreq0_TLPdelay551_Erosion5.3e-09/meansealevel.mat']);
...
filename = ['Outputs_CO' num2str(CO) '_RSLRA' num2str(RSLRA) '_spinuprampedRSLR1_runstartRSLR' num2str(RSLR) '_Breakwater0_SSCReduction0_breakwaterdelay551_TLP1_TLPthick0.05_TLPfreq15_TLPdelay551_Erosion' num2str(Erosion) '\'];
...
for SSCReduction=[0,10,20,30,40]
    filename = ['Outputs_CO' num2str(CO) '_RSLRA' num2str(RSLRA) '_spinuprampedRSLR1_runstartRSLR' num2str(RSLR) '_Breakwater1_SSCReduction' num2str(SSCReduction) '_breakwaterdelay551_TLP0_TLPthick0_TLPfreq0_TLPdelay551_Erosion' num2str(Erosion) '\'];
    myVars={'elev.mat','marsh edge.mat','meansealevel.mat','AnnualAccretion.mat','SLR.mat','resiliencymetrics.mat','VASEAmatrix.mat'};
    for i=1:7
        load([filename myVars{i}]);
    end
...
CO=10; RSLRA=0.08023;RSLR=3;Erosion=5.3e-09;
for SSCReduction=[0,10,20,30,40]
    filename = ['Outputs_CO' num2str(CO) '_RSLRA' num2str(RSLRA) '_spinuprampedRSLR1_runstartRSLR' num2str(RSLR) '_Breakwater1_SSCReduction' num2str(SSCReduction) '_breakwaterdelay551_TLP1_TLPthick0.05_TLPfreq15_TLPdelay551_Erosion' num2str(Erosion) '\'];
    myVars={'elev.mat','marsh edge.mat','meansealevel.mat','AnnualAccretion.mat','SLR.mat','resiliencymetrics.mat','VASEAmatrix.mat'};
    for i=1:7
        load([filename myVars{i}]);
    end
...
for CO=[10,20,30,40,50]
    filename=['Outputs_CO' num2str(CO) '_RSLRA' num2str(RSLRA) '_spinuprampedRSLR1_runstartRSLR3_Breakwater1_SSCReduction0_breakwaterdelay551_TLP0_TLPthick0_TLPfreq0_TLPdelay551_Erosion' num2str(k) '/'];
    myVars={'elev.mat','marsh edge.mat','meansealevel.mat','AnnualAccretion.mat','SLR.mat','resiliencymetrics.mat'};
    for i=1:6
        load([filename myVars{i}]);
    end
...
color='#7570b3';
for CO=[10,20,30,40,50]
    filename=['Outputs_CO' num2str(CO) '_RSLRA' num2str(RSLRA) '_spinuprampedRSLR1_runstartRSLR3_Breakwater0_SSCReduction0_breakwaterdelay551_TLP1_TLPthick0.05_TLPfreq15_TLPdelay551_Erosion' num2str(k) '/'];
    myVars={'elev.mat','marsh edge.mat','meansealevel.mat','AnnualAccretion.mat','SLR.mat','resiliencymetrics.mat'};
    for i=1:6
        load([filename myVars{i}]);
    end
...
color='#e6ab02';
for CO=[10,20,30,40,50]
    filename=['Outputs_CO' num2str(CO) '_RSLRA' num2str(RSLRA) '_spinuprampedRSLR1_runstartRSLR3_Breakwater1_SSCReduction0_breakwaterdelay551_TLP1_TLPthick0.05_TLPfreq15_TLPdelay551_Erosion' num2str(k) '/'];
    myVars={'elev.mat','marsh edge.mat','meansealevel.mat','AnnualAccretion.mat','SLR.mat','resiliencymetrics.mat'};
    for i=1:6
        load([filename myVars{i}]);
    end
...
color='#e7298a';
for CO=[10,20,30,40,50]
    filename=['Outputs_CO' num2str(CO) '_RSLRA' num2str(RSLRA) '_spinuprampedRSLR1_runstartRSLR3_Breakwater0_SSCReduction0_breakwaterdelay551_TLP0_TLPthick0_TLPfreq0_TLPdelay551_Erosion' num2str(k) '/'];
    myVars={'elev.mat','marsh edge.mat','meansealevel.mat','AnnualAccretion.mat','SLR.mat','resiliencymetrics.mat'};
    for i=1:6
        load([filename myVars{i}]);
    end
