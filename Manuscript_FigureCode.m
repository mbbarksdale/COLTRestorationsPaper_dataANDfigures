...
%% Fig 6: Comparisons of accretion rates/components for all 4 restoration strategies
...
%% Fig 7: Comparisons of eroded sediment accretion rates for TLP vs no-restoration
figure
set(gcf, 'Units', 'Normalized', 'OuterPosition', [0, 0, 0.6, 0.96],'InnerPosition',[0.09,0.6,0.4,0.4],'Position',[0.09,0.6,0.4,0.4]); %makes really large figure box (takes up most of computer screen)
k=7.8e-09;
RSLRA=0.08023;
...
hold on
l=legend([p4(1),p1(1),p2(1),p3(1),s1(1)],' No restoration    ',' Breakwater    ',' TLP    ',' TLP and Breakwater    ','TLP Year');
l.Location='southwest';
l.Orientation='horizontal';
l.EdgeColor='k';
l.Color=[0.97 0.97 0.97 0.97];
